          ...
          <View style={styles.itensSection}>
            ...
            <View style={styles.table}>
              ...
              {orcamento.mostrarValoresDetalhados !== false ? (
                ...
                <View style={styles.tableHeader}>
                  <Text style={[styles.tableHeaderText, { width: '10%' }]}>ITEM</Text>
                  <Text style={[styles.tableHeaderText, { width: '70%' }]}>DESCRIÇÃO DOS SERVIÇOS</Text>
                  <Text style={[styles.tableHeaderText, { width: '10%' }]}>UNID.</Text>
                  <Text style={[styles.tableHeaderText, { width: '10%' }]}>QTE.</Text>
                </View>
              )}
                ...
                return (
                  <View key={categoria}>
                    ...
                    <View style={stylesCompleto.categoriaRow}>
                      <Text style={[stylesCompleto.categoriaText, { width: orcamento.mostrarValoresDetalhados !== false ? '8%' : '10%' }]}>{categoriaNumero}.0</Text>
                    ...
                    {itensCategoria.map((item, idx) => {
                      ...
                      return orcamento.mostrarValoresDetalhados !== false ? (
                        ...
                        <View key={idx} style={isAlt ? styles.tableRowAlt : styles.tableRow}>
                          <Text style={{ width: '10%', fontSize: 8, textAlign: 'center' }}>{itemNum}</Text>
                          <Text style={{ width: '70%', fontSize: 8 }}>{item.descricao}</Text>
                          <Text style={{ width: '10%', fontSize: 8, textAlign: 'center' }}>{item.unidade || 'un'}</Text>
                          <Text style={{ width: '10%', fontSize: 8, textAlign: 'center' }}>{item.quantidade}</Text>
                        </View>
                      );
                    })}
              ...
              {orcamento.mostrarValoresDetalhados !== false ? (
                ...
                <View style={stylesCompleto.totalEtapaRow}>
                  ...
                  <Text style={{ width: '70%', fontSize: 9, fontWeight: 'bold', color: 'white' }}>TOTAL RESIDENCIAL</Text>
                  <Text style={{ width: '20%', fontSize: 9, textAlign: 'right', fontWeight: 'bold', color: 'white' }}>{formatCurrencyShort(itensResidenciais.reduce((acc, item) => acc + item.valorTotal, 0))}</Text>
                </View>
              )}
            </View>
          </View>
          ...
          <View style={styles.itensSection}>
            ...
            <View style={styles.table}>
              ...
              {orcamento.mostrarValoresDetalhados !== false ? (
                ...
                <View style={stylesCompleto.totalEtapaRow}>
                  <Text style={{ width: '10%', fontSize: 9 }}></Text>
                  <Text style={{ width: '70%', fontSize: 9, fontWeight: 'bold', color: 'white' }}>TOTAL COMERCIAL</Text>
                  <Text style={{ width: '20%', fontSize: 9, textAlign: 'right', fontWeight: 'bold', color: 'white' }}>{formatCurrencyShort(itensComerciais.reduce((acc, item) => acc + item.valorTotal, 0))}</Text>
                </View>
              )}
            </View>
          </View>
        ...
        <View style={stylesCompleto.limitacoesSection}>
          ...
          <View style={stylesCompleto.limitacoesBox}>
            ...
            {orcamento.observacoes && (
              <View style={stylesCompleto.limitacaoItem}>
                <Text style={stylesCompleto.limitacaoBullet}>•</Text>
                <Text style={stylesCompleto.limitacaoText}>{orcamento.observacoes}</Text>
              </View>
            )}
          </View>
        </View>
