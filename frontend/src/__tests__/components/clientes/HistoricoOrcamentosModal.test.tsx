...
const mockOrcamentos = [
  {
    ...
    itens: [{ descricao: 'Item 1', quantidade: 1, unidade: 'un', valorUnitario: 1000, valorTotal: 1000 }],
    createdAt: new Date(),
  },
  {
    id: 'o2',
    ...
    dataValidade: new Date(Date.now() + 30 * 24 * 60 * 60 * 1000).toISOString(),
    itens: [
      { descricao: 'Item 1', quantidade: 1, unidade: 'un', valorUnitario: 1500, valorTotal: 1500 },
      { descricao: 'Item 2', quantidade: 1, unidade: 'un', valorUnitario: 1000, valorTotal: 1000 },
    ],
    createdAt: new Date(),
  },
];
