...
type TabType = 'empresa' | 'palavras' | 'servicos' | 'categorias' | 'limitacoes';
...
export function Configuracoes() {
  ...
  const isLoading = loadingPalavras || loadingServicos || loadingCategorias || loadingLimitacoes || loadingConfiguracoes;
  ...
  return (
    <Container>
      ...
      <TabsContainer>
        ...
        <Tab $active={activeTab === 'palavras'} onClick={() => setActiveTab('palavras')}>
          Palavras-chave
        </Tab>
        <Tab $active={activeTab === 'servicos'} onClick={() => setActiveTab('servicos')}>
          Serviços
        </Tab>
        <Tab $active={activeTab === 'categorias'} onClick={() => setActiveTab('categorias')}>
          Categorias
        </Tab>
        <Tab $active={activeTab === 'limitacoes'} onClick={() => setActiveTab('limitacoes')}>
          Limitações
        </Tab>
      </TabsContainer>
